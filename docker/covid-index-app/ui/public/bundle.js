(function () {
    ...
    // (180:12) {#each getSidebarItems(results, 'purpose') as purpose}
    ...
    // (186:12) {#each getSidebarItems(results, 'tags') as tag}
